CREATE PROCEDURE [etl].[TellerVolumeReport_CurrentMonth]
...
--between first day of pervious month and first day of this month
WHERE ejd.[PROCDATE] >= DATEADD(month, DATEDIFF(month, 0, GETDATE()), 0)		-- Get first day of current month.
